...
| Layers of OSI - PDU and TCP/IP model | Layers name of TCP/IP and OSI model | Other view of the OSI Model|
| -------------------------------------|-----------------------------| ----- | -------------------------- |
| ![[Courses/TryHackMe/Networking/Images/OSI - PDU and TCP-IP.png]] 	   | ![[Courses/TryHackMe/Networking/Images/TCP-IP layers' name.png]]| ![[Courses/TryHackMe/Networking/Images/Other view of the OSI model.png]]               
